      ...
      <section className='w-screen flex justify-center pt-[88px]'>
        <div className='flex justify-between w-desktop'>
          <div className='flex flex-col gap-8'>
            {listings.filter((d, index) => index < firstCol ).map(d => {
              return(
              <Fragment key={d.id}>
                <DirectoryCard 
                  data={d}
          ...
          <div className='flex flex-col gap-8'>
            {listings.filter((d, index)=> index >= firstCol   && index < firstCol + secondCol ).map(d => {
              return(
              <Fragment key={d.name}>
                <DirectoryCard 
                  data={d}
          ...
          <div className='flex flex-col gap-8'>
            {listings.filter((d, index)=> index >= firstCol + secondCol  ).map(d => {
              return(
              <Fragment key={d.name}>
                <DirectoryCard 
                  data={d}
